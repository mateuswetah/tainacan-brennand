...
<div class="h-8 mb-0.5">
	<ul class="flex flex-wrap mt-0.5 mb-0.5 2xl:mb-0 mx-4 lg:mx-8 fixed z-[2] bg-[var(--background-color)]">
...
<?php
	...
	$term_list_title = '<h1 class="m0 pt-2 pb-[1.25rem] text-[2.5rem] leading-[2.68rem] uppercase border-b-3 lg:border-b-5 border-b-[var(--section-color)]">' . $current_taxonomy->labels->name . ': ' . $current_term->get_name(); '</h1>';
